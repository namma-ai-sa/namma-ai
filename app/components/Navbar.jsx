...
export default function Navbar() {
  ...
  return (
    <>
      ...
      <style jsx>{`
        .navbar-v3{position:sticky;top:0;z-index:999;width:100%;border-bottom:1px solid #e2e8f0;background:rgba(248,250,247,.9);backdrop-filter:blur(18px);box-shadow:0 8px 25px rgba(15,23,42,.05);font-family:Tahoma,Arial,sans-serif}.navbar-inner{width:min(1200px,calc(100% - 40px));min-height:78px;margin:auto;display:flex;align-items:center;gap:30px}.navbar-brand{display:flex;align-items:center;gap:9px;padding:0;border:0;background:transparent;color:#475569;cursor:pointer;direction:ltr}.navbar-mark{display:grid;place-items:center;width:32px;height:32px;border-radius:8px;background:#A3B18A;color:#fff;font-size:18px;font-weight:900}.navbar-wordmark{font-size:16px;font-weight:900;letter-spacing:.04em}.navbar-wordmark em{color:#A3B18A;font-size:11px;font-style:normal}.navbar-links{display:flex;align-items:center;gap:4px;margin-right:auto}.navbar-links button,.login-button{padding:10px 11px;border:0;background:transparent;color:#64748b;font-size:12px;font-weight:700;cursor:pointer;transition:color .2s,background .2s}.navbar-links button:hover{color:#A3B18A;background:#dcfce7;border-radius:6px}.navbar-actions{display:flex;align-items:center;gap:9px}.login-button{border:1px solid #e2e8f0;border-radius:6px;background:#fff;color:#475569}.login-button:hover{border-color:#bbf7d0;color:#A3B18A}.user-dot{margin-right:5px;color:#A3B18A}.start-button{padding:12px 17px;border:0;border-radius:6px;background:#A3B18A;color:#fff;font-size:12px;font-weight:800;cursor:pointer;box-shadow:0 7px 16px rgba(22,163,74,.2);transition:transform .2s,box-shadow .2s}.start-button:hover{transform:translateY(-2px);box-shadow:0 11px 22px rgba(22,163,74,.3)}.start-button span{margin-right:9px;font-size:16px}.menu-button{display:none;margin-right:auto;width:40px;height:40px;padding:9px;border:1px solid #e2e8f0;border-radius:6px;background:#fff;cursor:pointer}.menu-button span{display:block;width:19px;height:2px;margin:4px auto;border-radius:2px;background:#475569}.account-menu{position:absolute;top:70px;left:max(20px,calc((100% - 1200px) / 2));width:245px;padding:10px;border:1px solid #e2e8f0;border-radius:9px;background:#fff;box-shadow:0 20px 45px rgba(15,23,42,.14)}.account-heading{display:flex;align-items:center;gap:10px;padding:10px 9px 13px;border-bottom:1px solid #f1f5f9}.account-heading>span{display:grid;place-items:center;width:31px;height:31px;border-radius:7px;background:#dcfce7;color:#A3B18A}.account-heading b,.account-heading small{display:block}.account-heading b{font-size:12px}.account-heading small{margin-top:4px;color:#64748b;font-size:10px}.account-menu button,.mobile-menu button{display:flex;align-items:center;justify-content:space-between;width:100%;padding:11px 10px;border:0;border-radius:5px;background:transparent;color:#475569;text-align:right;font-size:12px;cursor:pointer}.account-menu button:hover,.mobile-menu>button:hover{background:#f0fdf4;color:#A3B18A}.account-menu .logout{margin-top:5px;border-top:1px solid #f1f5f9;border-radius:0;color:#dc2626}.mobile-menu{display:none}
