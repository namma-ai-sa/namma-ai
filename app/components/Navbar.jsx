...
export default function Navbar() {
  ...
  return (
    <>
      ...
      `}</style>
      <style jsx>{`
        .navbar-logo-image{width:auto;height:40px;max-width:132px;object-fit:contain}.mobile-menu-brand img{width:auto;height:40px;max-width:125px;object-fit:contain}
      `}</style>
    </>
  );
}