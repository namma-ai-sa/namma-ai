  ...
  return (
    <>
      ...
      <main className="enterprise-home" dir="rtl">
        ...
        `}</style>
        <style jsx>{`
          .dashboard-window>header b .dashboard-arabic-logo{display:none}.dashboard-window>header b i{display:inline;color:#15803d;font-size:8px;font-style:normal;letter-spacing:.06em}.home-footer>b img{display:block;width:auto;height:40px;max-height:40px;max-width:100%;object-fit:contain}.hero-brand img{display:block;width:auto;height:80px;max-height:80px;max-width:100%;object-fit:contain}
        `}</style>
      </main>
    </>
  );
