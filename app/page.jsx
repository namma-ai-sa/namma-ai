  ...
  return (
    <>
      ...
      <main className="enterprise-home" dir="rtl">
        ...
        `}</style>
        <style jsx>{`
          .dashboard-window>header b .dashboard-arabic-logo{display:inline-block;width:104px;height:27px;background:url("/namma-logo.png.png") center/contain no-repeat;font-size:0;vertical-align:middle}.dashboard-window>header b .dashboard-arabic-logo+ i{display:none}.home-footer>b img{display:block;width:132px;height:auto;max-height:40px;object-fit:contain}.hero-brand img{display:block;width:142px;height:auto;max-height:48px;object-fit:contain}
        `}</style>
      </main>
    </>
  );
